  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/server/services/bid-import.ts",
        "src/server/services/project-bids.ts",
        "src/server/services/bid-import-validation.ts",
        "src/server/services/matching-mutations.ts",
        "src/server/services/bid-import-preview.ts",
        ...
        "src/server/db/create-database.ts",
