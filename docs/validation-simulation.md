...
- **소규모 실제 파일럿은 진행할 가치가 있습니다.** 예시 결과에서는 인수처 확인 자료 검토 7/10명, 조건 탐색 4/10명, 배분안 확정 화면 진입 3/10명으로 행동 기준을 통과했습니다.
- **전담 개발 인력 투입은 보류해야 합니다.** 예시 결과에서 유료 파일럿에 참여한 기업은 5곳 중 1곳으로 목표인 2곳에 미치지 못했습니다. 배분안 확정 화면 진입과 유료 파일럿 기준을 함께 충족할 추정 확률도 30.9%였습니다.
