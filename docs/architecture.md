...
2. 검증을 마친 수요처가 자산군의 전체 수량에 제안한 입찰만 후보로 사용합니다. 검증 근거와 확인 시각이 있어야 하며, 서울 날짜를 기준으로 검증이 만료된 입찰은 재계산과 확정에서 제외합니다.
...
- DB 트리거가 입찰과 자산군의 프로젝트 일치 여부, 배정과 입찰의 프로젝트 및 수요처 일치 여부를 데이터베이스의 최종 경계에서 확인합니다.
...
- 조회자는 열람만 할 수 있습니다. 운영자는 재계산과 수거 상태를 기록하고, 승인자는 매칭안 확정과 외부 정산 확인을 수행할 수 있습니다.
